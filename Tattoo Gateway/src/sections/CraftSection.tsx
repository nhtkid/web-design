...
const CraftSection = ({ className = '' }: CraftSectionProps) => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // ENTRANCE (0%-30%) - with subtle rotation for drama
      ...
      scrollTl.fromTo(circleRef.current,
        { y: '60vh', scale: 0.35, opacity: 0, rotate: -6 },
        { y: 0, scale: 1, opacity: 1, rotate: 0, ease: 'power2.out' },
        0
      );
  ...
  return (
    ...
    >
      ...
      <p
        ...
        style={{ opacity: 0 }}
      >
        From stencil placement to final pass, I treat the small decisions as the main event—texture, edges, and flow tuned to your anatomy.
      </p>
