...
const ProcessSection = ({ className = '' }: ProcessSectionProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src={`${assetBase}process_bg_machine.jpg`}
          alt="Tattoo machine in action"
      ...
      <p
        ...
        style={{ opacity: 0 }}
      >
        Bold contrast, readable shapes, and skin-friendly pacing. I build pieces that age gracefully—clean lines, balanced saturation, and room to breathe.
      </p>
